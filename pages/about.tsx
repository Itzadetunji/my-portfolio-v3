...
const About: NextPage = () => {
	...
	return (
		<>
			...
			<div className="flex flex-col items-center mx-[40px] sm:mx-[50px] xl:mx-[85px]">
				<div className="pt-16 flex flex-col items-center justify-between space-x-14 md:flex-row w-full max-w-[1275px]">
					<div className="bg-gray w-full md:max-w-[525px] h-[400px] rounded-md" />
					<div className="flex flex-col min-w-[50%]">
						<div className="flex items-center justify-between">
							<h1 className="text-[32px] font-bold my-8 text-white">I&apos;m a FULL-STACK DEVELOPER</h1>
